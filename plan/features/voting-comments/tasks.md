...
`Verify:` `plan/architecture.md` lists `comments.deleted_at`; both docs in this directory carry
a dated NOTE matching shipped behaviour (server and web passes). Deploy-README entry for the
cleanup task: see the server hand-off notes below.
